...
complete -c iwctl -n "test (__fish_number_of_cmd_args_wo_opts) = 3; and __fish_seen_subcommand_from station" \
    -xa "connect connect-hidden disconnect get-hidden-access-points get-networks scan"
