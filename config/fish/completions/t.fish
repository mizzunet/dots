...
function __fish.task.complete
  ...
  complete -c t -u -k -f -n $check_function -a "(eval $list_command)"
end
...
complete -c t -u -k -f -n "__fish.task.before_command" -a "$__fish_task_static_commands_underscore"
complete -c t -u -k -f -n "__fish.task.before_command" -a "$__fish_task_static_commands_normal"
